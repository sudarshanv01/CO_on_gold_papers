...
def main(thermodb, referdb, list_cells, facet, functional):
    pour = Pourbaix(thermodb, referdb, list_cells, facet, functional)
    pour.get_pourbaix()
...
if __name__ == '__main__':
    ...
    j_ylim = {'100':[-70, 70], '111':[-120, 120], '211':[-70, 70], '110':[-70, 70]}
    ...
    # Plot related
    fig, ax1 = plt.subplots(2, len(facets), sharex=True, figsize=(30, 9))
