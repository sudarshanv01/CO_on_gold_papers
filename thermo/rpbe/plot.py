...
energydb = connect("Au_211_thermo.db")
...
CO_top_G = states_energy['CO_top'] + 0.03 - states_energy['slab'] - COg['G'] 
CO_bridge_G = states_energy['CO_bridge']+ 0.056 - states_energy['slab'] - COg['G']
