...
referdb = connect("references_QE.db")
...
CO_top_G = states_energy['CO_top'] + 0.067 - states_energy['slab'] - COg['G'] 
CO_bridge_G = states_energy['CO_bridge']+ 0.138 - states_energy['slab'] - COg['G']
